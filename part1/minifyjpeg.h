...
extern  minifyjpeg_out * minifyjpeg_proc_1(minifyjpeg_in , CLIENT *);
extern  minifyjpeg_out * minifyjpeg_proc_1_svc(minifyjpeg_in , struct svc_req *);
extern int minifyjpeg_prog_1_freeresult (SVCXPRT *, xdrproc_t, caddr_t);

#else /* K&R C */
#define MINIFYJPEG_PROC 1
extern  minifyjpeg_out * minifyjpeg_proc_1();
extern  minifyjpeg_out * minifyjpeg_proc_1_svc();
