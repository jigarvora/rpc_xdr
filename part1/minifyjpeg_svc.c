...
static minifyjpeg_out *
_minifyjpeg_proc_1 (minifyjpeg_in  *argp, struct svc_req *rqstp)
{
	return (minifyjpeg_proc_1_svc(*argp, rqstp));
}
...
{
	union {
		minifyjpeg_in minifyjpeg_proc_1_arg;
	} argument;
	char *result;
	...
	case MINIFYJPEG_PROC:
		_xdr_argument = (xdrproc_t) xdr_minifyjpeg_in;
		_xdr_result = (xdrproc_t) xdr_minifyjpeg_out;
		local = (char *(*)(char *, struct svc_req *)) _minifyjpeg_proc_1;
		break;
